...
class PptFactory {
    ...
    duplicateSlide(existingSlideName, newSlideName) {
        this.presentationFactory.addSlideRefIdToGlobalList(this.pptRelsFactory.addPresentationToSlideRelationship(newSlideName));
        return this.slideFactory.duplicateSlide(existingSlideName, newSlideName);
    }
    ...
    async addChart(slide, chart) {
        ...
        let worksheetName = `Microsoft_Excel_Sheet${this.embeddingsFactory.getWorksheetCount() + 1}.xlsx`;
